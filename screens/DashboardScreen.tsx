...
export function DashboardScreen() {
  return (
    <ScrollView className="flex-1 bg-neutral-50" contentContainerClassName="px-6 pb-10 pt-6">
      <View className="gap-1">
      ...
      <View className="mt-3">
        <Card className="bg-black">
          ...
          <Text className="mt-2 text-2xl font-bold text-white">Plan your next 15 minutes</Text>
      ...
      <View className="mt-8 gap-3">
        <Text className="text-sm font-semibold text-neutral-900">Quick actions</Text>
        <QuickAction title="Add a task" subtitle="Capture it before it disappears" />
